...
const styles = StyleSheet.create({
  ...
  emoji: { fontSize: 32 },
  title: { fontFamily: 'monospace', fontSize: 16, fontWeight: '700', textAlign: 'center' },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, justifyContent: 'center' },
  goalCard: {
    width: '47%', padding: 16, borderRadius: 12, borderWidth: 1,
    alignItems: 'center', gap: 6,
  },
  goalLabel: { fontFamily: 'monospace', fontSize: 13, fontWeight: '700' },
  goalPkgs: { fontFamily: 'monospace', fontSize: 9, textAlign: 'center' },
  skipBtn: { alignItems: 'center', marginTop: 16, paddingVertical: 8 },
  skipText: { fontFamily: 'monospace', fontSize: 12 },
  installingContainer: { alignItems: 'center', gap: 16, paddingVertical: 40 },
  installingStatus: { fontFamily: 'monospace', fontSize: 13, textAlign: 'center' },
