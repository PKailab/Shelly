...
const styles = StyleSheet.create({
  ...
  title: { flex: 1, fontFamily: 'monospace', fontSize: 16, fontWeight: '700' },
  alertBox: { marginHorizontal: 16, marginTop: 12, padding: 12, borderRadius: 8 },
  alertText: { fontFamily: 'monospace', fontSize: 12, lineHeight: 18 },
  stepIndicator: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 16, paddingTop: 12 },
  stepDot: { width: 8, height: 8, borderRadius: 4 },
  stepCount: { fontFamily: 'monospace', fontSize: 10, marginLeft: 'auto' },
  content: { maxHeight: 300 },
  contentInner: { padding: 16, gap: 12 },
  stepTitle: { fontFamily: 'monospace', fontSize: 15, fontWeight: '700' },
  stepDesc: { fontFamily: 'monospace', fontSize: 13, lineHeight: 20 },
  codeBox: { padding: 12, borderRadius: 8, borderWidth: 1 },
  codeText: { fontFamily: 'monospace', fontSize: 11, color: '#E8E8E8', lineHeight: 16 },
  ...
  copyText: { fontFamily: 'monospace', fontSize: 11, fontWeight: '600' },
