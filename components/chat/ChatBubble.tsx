      ...
      <View style={[styles.assistantBubble, { backgroundColor: colors.surfaceHigh, borderColor: withAlpha(agentColor, 0.15) }]}>
        ...
        {(!displayText || message.isStreaming || !isPlanOutput(displayText)) && (() => {
          const markdownStyles = {
            body: { color: colors.foregroundDim, fontSize, lineHeight: 18 },
            code_inline: { backgroundColor: withAlpha(colors.foreground, 0.08), color: colors.accent, fontSize: fontSize - 1, paddingHorizontal: 4, borderRadius: 3 },
            code_block: { backgroundColor: colors.surface, color: colors.foreground, fontSize: fontSize - 1, padding: 10, borderRadius: 6, lineHeight: 18 },
            fence: { backgroundColor: colors.surface, color: colors.foreground, fontSize: fontSize - 1, padding: 10, borderRadius: 6, lineHeight: 18 },
            heading1: { color: colors.foreground, fontSize: fontSize + 4, fontWeight: '700' as const, marginVertical: 6 },
            heading2: { color: colors.foreground, fontSize: fontSize + 2, fontWeight: '700' as const, marginVertical: 4 },
            heading3: { color: colors.foreground, fontSize: fontSize + 1, fontWeight: '600' as const, marginVertical: 3 },
